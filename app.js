...
// // Task 5
// var email = "fatimasaleem2812 @gmail.com"
...
// // document.write("with vowel <br>Finally the assignment of js is completed and i am really happy because i learn alot of things--FATIMA SALEEM-- <br>")//whole string
...
// // document.write(removeVowels('without vowel<br>Finally the assignment of js is completed and i am really happy because i learn alot of things--FATIMA SALEEM--'));//without vowel
...
// // //EVEVT//
// // // chap 43-48
// //  //TASK 1 BASICALLY WORK ON HTML
// // // </div> 
// // // <a href="#" onclick="alert('hey fatima is here')">onclick</a>
...
// //     img.src ="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Galaxy_Nexus_smartphone.jpg/170px-Galaxy_Nexus_smartphone.jpg"
// // }
// // function outimg(){
// //     var img =document.getElementById("img");
// //     img.src ="https://4.imimg.com/data4/BG/PA/GLADMIN-26190487/quickquotes-images_main-galaxy_j7_16gb_sm_j700f_gold_146703518919268600-500x500.jpg"
// // }
// // // TASK#5
...
// //   count -= 1;
// //   button2.innerHTML = "Click me: " + count;
// // };
// // // chap-49-52
...
// // var text=document.createTextNode("fatima here");
// // p.appendChild(text)
// // var last=document.getElementById("last-name");
// // last.appendChild(p)
// // var p=document.createElement('p');
// // var text=document.createTextNode("fatimasaleem2812@gmail.com");
// // p.appendChild(text)
// // var last=document.getElementById("email");
// // last.appendChild(p)

// // //task2
// // var b=document.getElementById("form-content")
// // console.log(b.nodeType)
// // var c=document.getElementById("last-name")
// // console.log(c.nodeType)
// // // console.log(c.childNodes[0].nodeType)//error
// // var a=document.getElementById('main-content')
